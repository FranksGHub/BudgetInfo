import 'package:budget_info/widgets/budget_info_page.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: AppLocalizations.of(context)?.appTitle ?? 'Budget Info',
      locale: _locale,
      theme: ThemeData(
      ...
      home: BudgetInfoPage(onLocaleChange: _changeLocale, currentLocale: _locale),
    );
  }
}
