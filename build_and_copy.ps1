...
$projectName = "Budget_Info" # insert your project name
...
# flutter build web --release --base-href "/budget/"
...
Compress-Archive -Path "$releaseDir\Windows" -DestinationPath "$releaseDir\Windows\Budget_Info.zip" -Force
